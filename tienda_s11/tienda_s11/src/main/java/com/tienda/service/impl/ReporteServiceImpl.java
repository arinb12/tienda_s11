...
public class ReporteServiceImpl implements ReporteService {
    ...
    public ResponseEntity<Resource> generaReporte(String reporte, Map<String, Object> parametros, String tipo) throws IOException {
        try {
            ...
            ByteArrayOutputStream salida = new ByteArrayOutputStream();// aqui cambiamos el codigo de reportes que está en bit, lo convertimos


            ClassPathResource fuente  //simulacion en codigo de donde esta el folder de reporte
            ...
            var reporteJasper //esta variable ya tiene el reporte generado con lo que nosotros tenemos en la base de datos
                    = JasperFillManager
                            .fillReport(
                                    elReporte,
                                    parametros,
